...
1. RankMath 100/100 es obligatorio.
2. Sanitizado HTML estricto (sin style, color, font, class mso-*).
3. Respeto total a scripts, embeds y shortcodes existentes.

---

## ESTRUCTURA OBLIGATORIA

- Uso correcto de H2, H3 y H4.
- Prohibido simular títulos con negritas.
- Cada párrafo envuelto en <p>.
- Citas en <blockquote><p>...</p></blockquote>.
...
## LÓGICA DE INYECCIÓN SEO (RANKMATH)

- Generar contenido para campos de RankMath (Title, Description, Focus Keyword) **únicamente si el campo está vacío**.
- Si el campo ya tiene contenido, solo proponer una mejora si se identifica una oportunidad clara de **Testing A/B** para mejorar el posicionamiento.

---

## ENLAZADO Y MEDIA

- 2 enlaces internos mínimos.
- 1 enlace externo DoFollow a fuente confiable.
